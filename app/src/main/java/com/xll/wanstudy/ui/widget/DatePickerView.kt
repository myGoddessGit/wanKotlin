...
import com.xll.wanstudy.listener.OnDatePickerSelectListener
import com.xll.wanstudy.tools.DATE_FORMAT_2
import com.xll.wanstudy.tools.millisSecondsToDateString
import java.util.*
...
class DatePickerView() {
    ...
    private fun initDialog(dialog: Dialog){
        ...
        dialogWindow?.let {
            it.setWindowAnimations(R.style.picker_view_scale_anim) // 修改样式动画
